...
<div class="d-flex">
    ...
    <div class="messageRead-wrapper">
        <c:choose>
            <c:when test="${type eq 'sended'}">
                <div class="text-center messageRead-title mb-5">보낸 쪽지</div>
            </c:when>
            <c:when test="${type eq 'received'}">
                <div class="text-center messageRead-title mb-5">받은 쪽지</div>
            </c:when>
        </c:choose>
            ...
            <c:when test="${type eq 'sended'}">
                <div class="mt-5">
                    <div class="text-center">
                        <button id="deleteBtn" class="btn btn-danger" style="width: 100px">삭제</button>
                    </div>
                </div>
            </c:when>
            <c:when test="${type eq 'received'}">
                <div class="mt-5">
                    <div class="text-center">
                        <button id="replyBtn" class="btn btn-success" style="width: 100px">답장</button>
                    </div>
                </div>
            </c:when>
        </c:choose>
